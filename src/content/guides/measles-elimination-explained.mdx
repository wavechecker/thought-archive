...
schema:
  medicalCondition:
    name: "Measles"
    description: "A highly contagious airborne viral infection preventable by MMR vaccination; elimination refers to interruption of endemic transmission in a defined region, which can be lost when vaccination coverage falls below the herd immunity threshold."
    alternateName:
      - "Rubeola"
      - "Morbilli"
    riskFactors:
      - "Unvaccinated or incompletely vaccinated status"
      - "Travel to regions with active transmission"
      - "Waning community immunity from declining vaccination rates"
    symptoms:
      - "High fever, cough, coryza, and conjunctivitis"
      - "Koplik spots (pathognomonic oral lesions)"
...
faq:
  - q: "What is measles elimination?"
    a: "Measles elimination means that sustained local transmission has been interrupted within a defined region — such as a country — for at least 12 months. It does not mean measles no longer exists globally."
  - q: "What is the difference between elimination and eradication?"
    a: "Elimination is the interruption of transmission in a defined region, which can be reversed if coverage drops. Eradication means the virus has been eliminated everywhere in the world. Smallpox has been eradicated; measles has not."
  - q: "Can a country lose measles elimination status?"
    a: "Yes. If outbreaks are long enough to show sustained local transmission, elimination status is revoked. Countries including the US and UK have lost and regained elimination status when vaccination coverage declined."
  - q: "Why is measles so difficult to keep eliminated?"
    a: "Measles requires approximately 95% population immunity to prevent outbreaks. Even modest drops in vaccination coverage allow transmission chains to re-establish rapidly, particularly in under-immunised communities."
  - q: "What is needed to maintain measles elimination?"
    a: "High two-dose MMR coverage above 95%, strong surveillance to detect and contain imported cases quickly, and sustained public trust in vaccination programs are all required."
---
