---
title: "Thyroid Disease: Symptoms, Tests, and Treatment"
description: "A patient-friendly guide to thyroid disease, including hypothyroidism, hyperthyroidism, thyroid nodules, blood tests, symptoms, treatment options, pregnancy considerations, and when to seek help."
...
draft: false
faq:
  - question: "What does the thyroid do?"
    answer: "The thyroid is a gland in the neck that makes hormones which help regulate metabolism, energy use, heart rate, temperature, digestion, and many other body functions."
  - question: "What is the difference between hypothyroidism and hyperthyroidism?"
    answer: "Hypothyroidism means the thyroid is underactive and produces too little thyroid hormone. Hyperthyroidism means the thyroid is overactive and produces too much thyroid hormone."
  - question: "What blood tests check thyroid function?"
    answer: "Common thyroid tests include TSH and free T4. Sometimes free T3, thyroid antibodies, or imaging are used depending on the symptoms and results."
  - question: "Can thyroid disease cause anxiety or palpitations?"
    answer: "Yes. An overactive thyroid can cause anxiety-like symptoms, tremor, sweating, fast heartbeat, or palpitations. These symptoms should be assessed because they can also have other causes."
  - question: "Can thyroid disease affect pregnancy?"
    answer: "Yes. Thyroid hormone levels matter during pregnancy and postpartum. People who are pregnant, planning pregnancy, or recently gave birth should discuss abnormal thyroid symptoms or test results with their care team."
---
...
See [Why Am I Always Tired?](/guides/why-am-i-always-tired) if fatigue is a primary concern, and [Depression: Symptoms, Causes, and Treatment](/guides/depression) if low mood is prominent.
...
Hyperthyroidism is a recognised risk factor for **atrial fibrillation** — an irregular heart rhythm that requires separate assessment and management. See [Atrial Fibrillation: Symptoms, Risks, and Treatment](/guides/atrial-fibrillation) and [Heart Palpitations: When to Worry](/guides/heart-palpitations).

Symptoms such as anxiety, palpitations, and weight loss have many causes. Testing is needed to determine whether the thyroid is responsible. See [Anxiety Disorders](/guides/anxiety) if anxiety is a primary concern.
...
The symptoms of postpartum thyroiditis can be mistaken for postpartum depression or anxiety. If mood, energy, or anxiety symptoms persist after birth, thyroid testing is a reasonable part of the clinical assessment. See [Postpartum Depression: Symptoms, Risks, and Treatment](/guides/postpartum-depression).
...
For pregnancy-related metabolic health and diabetes, see [Gestational Diabetes: Screening, Treatment, and Follow-Up](/guides/gestational-diabetes). For postnatal mood, see [Postpartum Depression: Symptoms, Risks, and Treatment](/guides/postpartum-depression).
...
See [Why Am I Always Tired?](/guides/why-am-i-always-tired) for a broader guide to investigating persistent fatigue, and [Women's Health Hub](/guides/womens-health-hub) for hormonal and reproductive causes of overlapping symptoms.
...
- [NHS — Overactive Thyroid (Hyperthyroidism)](https://www.nhs.uk/conditions/overactive-thyroid-hyperthyroidism/)
- [MedlinePlus — Thyroid Diseases](https://medlineplus.gov/thyroiddiseases.html)
- [American Thyroid Association — Patient Resources](https://www.thyroid.org/patient-thyroid-information/)
- [Healthdirect — Thyroid Problems (Australia)](https://www.healthdirect.gov.au/thyroid-problems)

---

## Related Guides

- [Why Am I Always Tired?](/guides/why-am-i-always-tired) — fatigue is one of the most common symptoms of hypothyroidism; a broader guide to identifying the cause of persistent tiredness
- [Heart Palpitations: When to Worry](/guides/heart-palpitations) — palpitations can be a symptom of hyperthyroidism; when to seek assessment
- [Atrial Fibrillation: Symptoms, Risks, and Treatment](/guides/atrial-fibrillation) — hyperthyroidism is a recognised trigger for atrial fibrillation
...
- [Preventive Screening Hub](/guides/preventive-screening-hub) — thyroid blood tests and when targeted testing is appropriate
