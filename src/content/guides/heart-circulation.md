...
faq:
  - question: "What is heart disease?"
    answer: "Heart disease refers to a range of conditions affecting the heart and blood vessels, including coronary artery disease (blocked arteries), heart failure, arrhythmias (abnormal heart rhythms), and structural heart problems. Coronary artery disease — the build-up of plaque in arteries — is the most common and the leading cause of heart attacks."
  - question: "What are the warning signs of a heart attack?"
    answer: "Classic symptoms include central chest pain or pressure, pain radiating to the arm, neck, or jaw, shortness of breath, sweating, and nausea. Women, younger adults, and people with diabetes may experience atypical symptoms such as fatigue, back pain, or indigestion. If you suspect a heart attack, call emergency services immediately."
  - question: "What is atrial fibrillation?"
    answer: "Atrial fibrillation (AF or AFib) is the most common heart arrhythmia. The upper chambers of the heart beat chaotically and out of sync with the lower chambers, causing an irregular pulse, palpitations, breathlessness, and fatigue. AF significantly increases stroke risk and usually requires treatment with blood thinners and rate or rhythm control medication."
  - question: "How can I reduce my risk of heart disease?"
    answer: "The most effective steps are not smoking, eating a diet low in saturated fat and high in vegetables, fruit, and whole grains, exercising regularly (at least 150 minutes of moderate activity per week), maintaining a healthy weight, keeping blood pressure and cholesterol within normal ranges, managing diabetes, and limiting alcohol."
  - question: "What is coronary angiography?"
    answer: "Coronary angiography (cardiac catheterisation) is a procedure in which a thin tube (catheter) is inserted into a blood vessel and guided to the heart, where dye is injected so X-rays can reveal blockages in the coronary arteries. It can be combined with angioplasty and stenting to open blocked arteries."
  - question: "What is cardiac rehabilitation?"
    answer: "Cardiac rehabilitation (cardiac rehab) is a supervised programme of exercise, education, and psychological support for people recovering from a heart attack, heart surgery, or other cardiac event. It reduces the risk of a further heart event by approximately 25% and helps people return to an active life."
  - question: "What medications are commonly used for heart conditions?"
    answer: "Common cardiac medications include statins (to lower cholesterol), ACE inhibitors and ARBs (to lower blood pressure and protect the heart), beta-blockers (to slow heart rate and reduce workload), antiplatelet drugs such as aspirin and clopidogrel (to prevent clots), anticoagulants such as warfarin or direct oral anticoagulants (to prevent stroke in AF), and diuretics (to reduce fluid in heart failure)."
  - question: "What is the difference between angina and a heart attack?"
    answer: "Angina is chest pain caused by temporarily reduced blood flow to the heart muscle, usually during exertion, which eases with rest or nitrate medication. A heart attack (myocardial infarction) occurs when a coronary artery is completely blocked and part of the heart muscle begins to die. A heart attack requires emergency treatment."
  - question: "How does high blood pressure affect heart health?"
    answer: "High blood pressure (hypertension) forces the heart to work harder and damages blood vessel walls over time, increasing the risk of heart attack, stroke, heart failure, and kidney disease. It often has no symptoms, which is why regular measurement is important."
  - question: "When should I call an ambulance for a heart problem?"
    answer: "Call emergency services immediately for: severe or crushing chest pain, chest pain with arm, jaw, or neck pain, sudden breathlessness at rest, palpitations with dizziness or collapse, or any episode of loss of consciousness. Do not drive yourself to hospital."
---
...
- [Peripheral Artery Disease: Leg Pain, Circulation, and When to Seek Help](/guides/peripheral-artery-disease) — claudication, poor circulation, foot care, risk factors, diagnosis, vascular procedures, and urgent limb red flags
...
Heart disease covers a range of conditions affecting the heart and blood vessels — most commonly coronary artery disease (blocked arteries), which is the leading cause of heart attacks.

**Q: What are the warning signs of a heart attack?**
Classic symptoms are central chest pain or pressure, pain radiating to the arm, neck, or jaw, shortness of breath, sweating, and nausea. Women and people with diabetes may have atypical symptoms — back pain, fatigue, indigestion. Call emergency services immediately if you suspect a heart attack.

**Q: What is atrial fibrillation?**
The most common heart arrhythmia: the upper chambers beat chaotically, causing an irregular pulse, palpitations, and breathlessness. AF greatly increases stroke risk and needs active management.

**Q: How can I reduce my risk of heart disease?**
The most effective steps: not smoking, eating a heart-healthy diet, exercising regularly, maintaining healthy weight, keeping blood pressure and cholesterol controlled, managing diabetes, and limiting alcohol.

**Q: What is coronary angiography?**
A procedure where dye is injected into the coronary arteries via a catheter so X-rays can reveal blockages. It can be combined with angioplasty and stenting to restore blood flow.

**Q: What is cardiac rehabilitation?**
A supervised programme of exercise, education, and psychological support after a cardiac event. It reduces the risk of another event by ~25%.

**Q: What medications are used for heart conditions?**
Statins, ACE inhibitors, beta-blockers, antiplatelet drugs (aspirin, clopidogrel), anticoagulants, and diuretics — depending on the condition.

**Q: What is the difference between angina and a heart attack?**
Angina is temporary chest pain during exertion caused by reduced blood flow, which resolves with rest or nitrates. A heart attack is a complete arterial blockage with permanent muscle damage if not treated urgently.

**Q: How does high blood pressure affect heart health?**
It forces the heart to overwork and damages blood vessels, raising the risk of heart attack, stroke, heart failure, and kidney disease. It usually has no symptoms.

**Q: When should I call an ambulance?**
Immediately for severe chest pain, chest pain with arm or jaw pain, sudden breathlessness at rest, collapse, or symptoms that could be stroke. Do not drive yourself.
...
- [American Heart Association](https://www.heart.org/) — Comprehensive patient resources, guidelines, and lifestyle guidance.
- [European Society of Cardiology — Patient Resources](https://www.escardio.org/Patients) — Evidence-based European cardiology patient information.
- [World Heart Federation](https://world-heart-federation.org/) — Global heart disease statistics and prevention campaigns.

---

## Related Guides

- [Peripheral Artery Disease: Leg Pain, Circulation, and When to Seek Help](/guides/peripheral-artery-disease) — PAD is part of the same atherosclerotic spectrum as coronary artery disease; people with PAD face elevated heart attack and stroke risk
