...
draft: false
faq:
  - q: "What is algorithmic bias in healthcare?"
    a: "Algorithmic bias occurs when AI systems produce systematically less accurate or less equitable outputs for certain groups — typically because training data underrepresents them or contains historical inequities embedded in prior clinical decisions."
  - q: "Which groups are most at risk from algorithmic bias?"
    a: "Research has identified bias affecting racial and ethnic minorities, women, older adults, lower-income groups, and people from regions underrepresented in training datasets. Bias can affect diagnostic accuracy, treatment recommendations, and resource allocation."
  - q: "Can algorithmic bias affect my care?"
    a: "It is possible, particularly if you belong to a group underrepresented in the data used to develop an AI tool. Questions about a tool's validation population are appropriate when AI informs clinical decisions."
  - q: "What is being done to address algorithmic bias?"
    a: "Regulatory frameworks increasingly require developers to test AI tools for subgroup performance, document limitations, and report disparities before deployment. Research institutions and health systems are developing bias auditing practices."
  - q: "How should clinicians handle AI outputs given the risk of bias?"
    a: "Clinicians should treat AI outputs as one input alongside clinical judgement, consider whether the patient population matches the tool's validation data, and apply independent reasoning rather than deferring automatically to AI recommendations."
---
