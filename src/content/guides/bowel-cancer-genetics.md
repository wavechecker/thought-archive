...
schema:
  medicalCondition:
    name: "Familial Bowel Cancer Risk"
    description: "Approximately 1 in 10 bowel (colorectal) cancers are linked to inherited genetic factors, including Lynch syndrome, familial adenomatous polyposis (FAP), and a family history of colorectal cancer. These conditions can increase lifetime bowel cancer risk significantly and often warrant earlier screening."
    alternateName:
    ...
    riskFactors:
      ...
      - "First-degree relative with bowel cancer before age 60"
    ...
    possibleComplication:
      - "Colorectal cancer"
      - "Other associated cancers in Lynch syndrome (endometrial, ovarian, stomach)"
    contagious: false
    sameAs:
...
faq:
  - q: "How does family history affect bowel cancer risk?"
    a: "Having a first-degree relative (parent, sibling, or child) diagnosed with bowel cancer before age 60 roughly doubles your lifetime risk compared to the general population. If two or more first-degree relatives are affected, or if the family pattern suggests a hereditary syndrome such as Lynch syndrome, the risk is higher still and earlier, more frequent screening is recommended."
  - q: "When should I seek urgent care for bowel cancer symptoms?"
    a: "See your doctor promptly (within 2 weeks) for: rectal bleeding especially with change in bowel habits, unexplained weight loss, persistent abdominal pain, or change in stool consistency lasting more than 3 weeks. Seek emergency care for: severe abdominal pain, complete inability to pass stool or gas (possible obstruction), or significant rectal haemorrhage."
---
