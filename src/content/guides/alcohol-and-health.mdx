...
faq:
  - q: "Is there a safe level of alcohol consumption?"
    a: "Current evidence does not establish a safe level of alcohol for cancer risk. Alcohol is classified as a Group 1 carcinogen by the IARC. Earlier claims that moderate drinking was heart-protective are now largely attributed to confounding in study design."
  - q: "Does alcohol cause cancer?"
    a: "Yes. Alcohol is a proven cause of at least seven cancer types, including breast, colorectal, liver, oesophageal, oral, pharyngeal, and laryngeal cancers. Risk increases with the amount consumed; even low to moderate drinking carries some increase in cancer risk."
  - q: "What about the claimed heart benefits of red wine?"
    a: "This association has largely been undermined by better study designs. Observational studies comparing moderate drinkers to abstainers are confounded by sick quitters (people who stopped drinking due to illness). Stronger evidence finds minimal or no cardiovascular benefit, while cancer risk remains elevated at any level."
  - q: "How quickly does alcohol leave the body?"
    a: "On average, the body processes one standard drink per hour. Food, liver health, age, and genetics all affect this rate. There is no way to speed up alcohol metabolism — coffee, water, and fresh air do not accelerate it."
  - q: "What should I do if I want to reduce my alcohol intake?"
    a: "Reducing intake gradually, identifying triggers, setting specific goals, and seeking support from a GP or counsellor are evidence-based starting points. For people with alcohol dependence, withdrawal can be medically serious — speak to a doctor before stopping suddenly."
schema:
  medicalCondition:
    name: "Alcohol-Related Disease"
    description: "A spectrum of health harms caused by alcohol consumption — a Group 1 IARC carcinogen — including liver disease, cancers, cardiovascular damage, and neurological impairment, with no safe level established for cancer risk."
    alternateName:
      ...
      - "Alcohol dependence"
    riskFactors:
      - "Regular alcohol consumption at any dose"
      - "Heavy episodic (binge) drinking"
      - "Daily alcohol use"
      - "Genetic predisposition to alcohol dependence"
      - "Early-onset drinking"
    symptoms:
      - "Craving, loss of control, and tolerance (alcohol dependence)"
      - "Fatigue and jaundice (liver disease)"
      - "Sleep disruption and poor sleep quality"
      - "Cognitive impairment with long-term heavy use"
    possibleComplication:
      - "Cirrhosis and liver failure"
      - "Cancers (oral cavity, pharynx, larynx, oesophagus, liver, breast, colorectum)"
      - "Cardiomyopathy and hypertension"
      - "Alcohol withdrawal syndrome (medically serious — can be fatal)"
      - "Wernicke-Korsakoff syndrome"
    contagious: false
    sameAs:
      - "https://www.who.int/news-room/fact-sheets/detail/alcohol"
      - "https://www.cdc.gov/alcohol/index.html"
      - "https://medlineplus.gov/alcoholusedisordersud.html"
jsonld:
