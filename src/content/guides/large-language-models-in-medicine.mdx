...
faq:
  - q: "What is a large language model?"
    a: "A large language model (LLM) is an AI system trained on large text datasets to generate, summarise, and answer questions in natural language. Examples include GPT-4 and Claude."
  - q: "How are LLMs being used in healthcare?"
    a: "LLMs are being explored for clinical note summarisation, patient communication, administrative tasks, medical education, and clinical decision support. Some are being embedded in electronic health record systems."
  - q: "Are LLMs accurate for medical questions?"
    a: "LLMs can answer many medical questions correctly but also produce confident-sounding errors (hallucinations). Performance varies by topic and they are not validated replacements for clinical assessment."
  - q: "What are the key risks of LLMs in medicine?"
    a: "Key risks include hallucination, automation bias, patient privacy concerns when clinical data is involved, inconsistency across queries, and uncertainty about accountability when errors occur."
  - q: "Can LLMs access my health records?"
    a: "Not unless specifically integrated with a health system. Consumer AI tools do not connect to clinical records by default. Some health systems are piloting LLMs within electronic health records under data governance frameworks."
---
