...
faq:
  - q: "What is CJC-1295?"
    a: "CJC-1295 is a synthetic analogue of growth hormone-releasing hormone (GHRH) designed to stimulate the pituitary gland to release growth hormone. A chemical modification extends its duration of action compared to shorter-acting GHRH analogues."
  - q: "Is CJC-1295 an approved medication?"
    a: "No. CJC-1295 is not approved as a prescription drug in most countries. It is discussed in research and peptide clinic contexts, but lacks large human clinical trial evidence."
  - q: "What is CJC-1295 used for?"
    a: "Online communities discuss it for body composition, recovery, and anti-aging. There are no large human clinical trials supporting these uses. Treatment choices involving hormones should be individualised under medical supervision."
  - q: "What are the risks of CJC-1295?"
    a: "Potential risks include fluid retention, joint pain, and blood sugar changes associated with elevated growth hormone levels. Products sold outside regulated pharmaceutical channels carry additional quality and safety concerns."
  - q: "Do I need a prescription for CJC-1295?"
    a: "In most countries, yes — or it may not be available through legitimate medical channels. Products sold online as research chemicals are unregulated and of uncertain quality. Do not start, stop, or change any hormone therapy without clinician advice."
schema:
  medicalCondition:
    name: "Growth Hormone Deficiency"
    description: "A condition of inadequate growth hormone production from the pituitary gland, causing reduced muscle mass, increased visceral fat, fatigue, and metabolic effects; CJC-1295 is an experimental synthetic GHRH analogue investigated to stimulate GH release."
    alternateName:
      - "GHD"
    ...
    riskFactors:
      ...
      - "Radiation to the hypothalamus or pituitary"
      - "Age-related decline in growth hormone secretion (somatopause)"
    symptoms:
      - "Reduced muscle mass and increased visceral adiposity"
      - "Fatigue and reduced exercise capacity"
      - "Mood changes, depression, and impaired wellbeing"
      - "Reduced bone density"
    possibleComplication:
      - "Increased cardiovascular risk from metabolic effects"
      - "Osteoporosis and fracture risk"
      - "Psychological effects including depression and anxiety"
    contagious: false
    sameAs:
      - "https://medlineplus.gov/ency/article/001176.htm"
      - "https://www.nhs.uk/conditions/growth-hormone-deficiency/"
---
