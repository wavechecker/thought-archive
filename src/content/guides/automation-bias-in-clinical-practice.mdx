...
faq:
  - q: "What is automation bias?"
    a: "Automation bias is the tendency to follow automated recommendations more than warranted, often at the expense of independent reasoning. In medicine, it can cause clinicians to accept AI outputs without adequately scrutinising them."
  - q: "Is automation bias a real risk in healthcare?"
    a: "Yes. Research has documented automation bias in radiology, emergency triage, and laboratory interpretation. It is considered a patient safety concern wherever AI tools are embedded in clinical workflows."
  - q: "How can patients protect themselves from automation bias?"
    a: "Patients can ask what evidence or tools informed a decision, whether AI-assisted systems were involved, and how uncertainty is being managed. Understanding how decisions are made supports informed shared decision-making."
  - q: "Does AI always give correct medical recommendations?"
    a: "No. AI systems make errors, particularly in cases that differ from their training data. Automation bias is a risk precisely because users sometimes accept AI outputs as more reliable than the evidence justifies."
  - q: "What can clinicians do to reduce automation bias?"
    a: "Best practice includes forming an independent clinical assessment before reviewing AI output, rather than anchoring on the AI recommendation first. Awareness training and structured decision protocols can also help."
---
