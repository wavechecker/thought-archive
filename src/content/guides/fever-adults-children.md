...
faq:
  ...
  - q: "When should I call emergency services for a fever in a child?"
    a: "Call emergency services or go to the emergency department immediately if a child has a fever and is under 3 months old; has a non-blanching rash (a rash that does not fade when a glass is pressed firmly against it); has a seizure; is unresponsive, very difficult to wake, or floppy; or is breathing rapidly or with difficulty."
  - q: "Can I give paracetamol and ibuprofen together for fever?"
    a: "You can use either paracetamol or ibuprofen to manage fever and discomfort — they should not be given at the same time. Alternating them at staggered intervals is sometimes used but is not routinely recommended unless a clinician advises it. Always follow dosing instructions carefully, especially for children."
  - q: "Should I try to sweat out a fever?"
    a: "No. Wrapping a feverish person in heavy blankets to 'sweat it out' can cause dangerous overheating. Keep clothing light, maintain a comfortable room temperature, and encourage regular fluids to prevent dehydration."
  - q: "What is a febrile seizure and is it dangerous?"
    a: "A febrile seizure is a convulsion triggered by a rapidly rising fever in young children, most commonly between 6 months and 5 years. Most last under 5 minutes and do not cause long-term harm. However, any first seizure should be evaluated by a doctor, and emergency services should be called. Do not restrain the child — protect them from injury and note how long it lasts."
  - q: "How do I know if a rash with fever is dangerous?"
    a: "A non-blanching rash — one that does not fade or turn white when you press a clear glass firmly against it — alongside fever can indicate meningococcal disease or septicaemia, which are medical emergencies. If the rash does not blanch, call emergency services immediately. Do not wait."
  - q: "Can adults have febrile seizures?"
    a: "Febrile seizures in adults are rare. A seizure in an adult with a high fever should be treated as a medical emergency — it can indicate meningitis, encephalitis, or other serious conditions requiring urgent investigation."
  - q: "What does fever without a source mean in a young baby?"
    a: "In infants under 3 months, a fever without an obvious explanation — no cold symptoms, no rash, no apparent infection — is considered high risk because their immune systems are immature and serious bacterial infections can be hard to detect clinically. These babies need urgent medical assessment, often including blood and urine tests."
---
...
1. **Monitor temperature** using an accurate thermometer. Axillary (armpit), oral, or ear thermometers are reliable. Forehead adhesive strips are less accurate.
2. **Keep the person hydrated** — small, frequent sips of water, or oral rehydration solution if vomiting. Continue breastfeeding or formula feeding in infants as normal, with extra feeds if tolerated.
3. **Dress lightly** — remove heavy layers. Keep the room at a comfortable temperature around 18–20°C. Do not wrap in blankets.
4. **Give fever-reducing medicine if the person is uncomfortable** — use the correct dose for age and weight.
5. **Check for red-flag symptoms regularly** — especially perform the glass test on any new rash.
...
Above 38°C (100.4°F) is generally considered a fever. High fever is above 39.4°C (103°F). A temperature above 40°C (104°F) that is not responding to medication, or one accompanied by confusion, severe headache, or a non-blanching rash, requires urgent emergency evaluation.

**When should I take a baby to the emergency department?**
Any fever in a baby under 3 months old (above 38°C / 100.4°F) should be assessed urgently — even if the baby appears well. At this age, serious infections can progress rapidly and may show very few outward signs.

**Should I try to sweat out a fever?**
No. Heavy blankets trap heat and can cause dangerous overheating. Keep the person lightly dressed in a cool room and ensure they take regular fluids.

**What is the glass test and when should I use it?**
Press a clear glass firmly against any rash. If the rash does not fade with sustained firm pressure, it may indicate meningococcal septicaemia — a life-threatening emergency. Call emergency services immediately if the rash does not blanch.

**What is a febrile seizure?**
A convulsion triggered by a rapidly rising fever in children aged 6 months to 5 years. Most last under 5 minutes and do not cause lasting harm — but call emergency services for any first seizure or one lasting more than 5 minutes. Do not restrain the child; protect them from injury and note how long it lasts.

**Can I alternate paracetamol and ibuprofen?**
You can use one or the other as needed. Alternating is sometimes recommended by clinicians but is not routine standard practice. Never give both at the same time, and always follow dosing instructions for the child's weight.

**How long should a fever last?**
Most viral fevers resolve within 3–5 days. A fever that lasts more than 3 days, keeps rising despite medication, or is associated with worsening symptoms should be evaluated by a clinician. Bacterial infections often require antibiotic treatment.

**Is fever dangerous in immunocompromised people?**
Yes. People on chemotherapy, immune-suppressing medications, or with HIV should treat any fever — even a low-grade one — as potentially serious and seek prompt medical assessment.

## Further Reading

- [NHS — Fever in Adults](https://www.nhs.uk/conditions/fever-in-adults/)
- [NHS — High Temperature in Children](https://www.nhs.uk/conditions/fever-in-children/)
- [American Academy of Pediatrics (HealthyChildren.org) — Fever and Your Child](https://www.healthychildren.org/English/health-issues/conditions/fever/Pages/When-to-Call-the-Pediatrician.aspx)
- [World Health Organization — Managing Fever](https://www.who.int/news-room/q-a-detail/fever)
