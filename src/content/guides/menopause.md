---
title: "Menopause: Symptoms, Stages, and What to Expect"
slug: "menopause"
description: >-
  A comprehensive guide to menopause — covering perimenopause, the hormonal
  transition, common symptoms, bone and cardiovascular health, treatment options,
...
schema:
  medicalCondition:
    name: "Menopause"
    description: >-
      The permanent cessation of menstruation that occurs when ovarian follicle
      activity ends, defined clinically as 12 consecutive months without a period
      in the absence of other causes. The average age of onset in Western
      populations is 51–52 years. The menopausal transition (perimenopause)
      precedes this by 2–8 years and involves fluctuating oestrogen and
      progesterone levels causing irregular cycles and a range of symptoms.
    alternateName:
      - "perimenopause"
      - "climacteric"
      - "the change"
...
faq:
  - q: "What is the difference between perimenopause and menopause?"
    a: >-
      Perimenopause is the transition phase before menopause, during which
      hormone levels fluctuate and periods become irregular. It can last
      anywhere from 2 to 8 years. Menopause itself is defined as 12
      consecutive months without a period, confirmed retrospectively. The
      average age of menopause in Australia is around 51–52 years. Many of
      the symptoms people associate with "menopause" — hot flushes, sleep
      disturbance, mood changes — actually begin during perimenopause.
  - q: "How long do hot flushes last?"
    a: >-
      Duration varies widely. On average, vasomotor symptoms (hot flushes and
      night sweats) persist for about 7 years, though some women experience
      them for 10–15 years or longer. Symptoms tend to be most frequent and
      severe in the first two years after the final period. For some women,
      flushes are mild and manageable; for others, they significantly disrupt
      work and sleep. Hormone therapy is the most effective treatment for
      vasomotor symptoms.
  - q: "Is hormone therapy (HRT) safe?"
    a: >-
      For most healthy women under 60, or within 10 years of menopause, the
      benefits of hormone therapy typically outweigh the risks. The risks —
      including a small increase in breast cancer risk with combined
      oestrogen-progestogen therapy — depend on the formulation, route of
      administration, duration of use, and the individual's health history.
      Transdermal oestrogen carries lower thrombosis risk than oral
      preparations. Decisions should be made with your doctor, weighing your
      specific symptoms, risks, and values. See our full guide on hormone
      therapy for a detailed breakdown.
  - q: "Can menopause affect my heart?"
    a: >-
      Yes. Oestrogen has protective effects on blood vessels, and its decline
      at menopause is associated with an accelerated increase in cardiovascular
      risk — including rises in LDL cholesterol, blood pressure, and
      inflammatory markers. Women's cardiovascular risk, which is lower than
      men's before menopause, tends to converge with men's risk in the
      post-menopausal years. This makes heart health monitoring — blood
      pressure checks, lipid profiles, and lifestyle optimisation — especially
      important from midlife onwards.
  - q: "What is postmenopausal bleeding and should I be worried?"
    a: >-
      Any vaginal bleeding that occurs 12 or more months after your last
      period is postmenopausal bleeding and requires prompt medical evaluation.
      Most causes are benign — atrophic vaginitis, endometrial polyps, or
      hormonal effects — but endometrial cancer must be excluded. Do not
      wait to see if it resolves. See your GP or gynaecologist promptly for
      assessment, which typically involves a pelvic ultrasound and possible
      endometrial biopsy.
  - q: "Does menopause cause bone loss?"
    a: >-
      Yes. The accelerated phase of bone loss begins in the 2–3 years before
      the final menstrual period and continues for about 5–7 years afterwards.
      Women can lose 10–20% of bone density during this window. This raises
      the long-term risk of osteoporosis and fragility fractures. Weight-bearing
      exercise, adequate calcium and vitamin D, and — where appropriate —
      hormone therapy or other bone-protective treatments all play a role in
      preserving bone mass during and after the transition.
  - q: "What can I do about vaginal dryness and discomfort?"
    a: >-
      Genitourinary symptoms of menopause (GSM) — including vaginal dryness,
      irritation, painful intercourse, and urinary frequency — are caused by
      oestrogen-deficient thinning of vaginal and urethral tissue. Unlike hot
      flushes, these symptoms typically worsen over time if untreated. Effective
      options include local vaginal oestrogen (cream, pessary, or ring), DHEA
      vaginal suppositories, and non-hormonal vaginal moisturisers. Local
      oestrogen therapy is generally safe even for women who cannot take
      systemic HRT.
  - q: "Does menopause cause depression?"
    a: >-
      The perimenopause is a window of elevated vulnerability for depressive
      symptoms, particularly in women with a prior history of depression or
      premenstrual mood sensitivity. This is partly attributable to hormonal
      fluctuations and partly to sleep disruption and life-stage stressors.
      However, menopause does not inevitably cause depression, and not all mood
      changes require antidepressants. Some women with perimenopausal depression
      respond well to hormone therapy; others benefit from psychological
      therapies or conventional antidepressants. Assessment by a doctor is
      important to identify the right approach.
---
...
For most healthy women aged under 60, or within 10 years of menopause, benefits typically outweigh risks. Duration should be reviewed periodically. See the [Hormone Therapy for Menopause](/guides/hormone-therapy-menopause) guide for a full risk-benefit breakdown.

### Non-Hormonal Options

For women who cannot or choose not to use hormone therapy:

| Option | Evidence | Best For |
|---|---|---|
...
| Gabapentin / pregabalin | Moderate | Vasomotor symptoms; night sweats |
| Cognitive behavioural therapy (CBT) | Good — reduces distress; improves sleep | Mood, sleep, coping |
| Clonidine | Modest | Hot flushes |
| Fezolinetant (NK3 receptor antagonist) | Strong (new) | Vasomotor symptoms — non-hormonal prescription option |
| Local vaginal oestrogen | Excellent for GSM | GSM (safe even when systemic HRT is not) |
...
|---|---|
| **Postmenopausal bleeding** | Must exclude endometrial cancer |
| Intermenstrual bleeding (new or heavy) in perimenopause | May indicate endometrial pathology |
| Sudden severe hot flushes at any age under 40 | May indicate premature ovarian insufficiency |
| New chest pain, palpitations, or breathlessness | Cardiovascular evaluation |
| Severe or rapidly worsening mood symptoms | Depression, not simply perimenopause |
| Urinary symptoms with fever or loin pain | Urinary tract infection or pyelonephritis |
...
**Q: At what age does menopause start?**
The average age of menopause in Australia is 51–52 years. The normal range is roughly 45–55. Menopause before 40 is classified as premature ovarian insufficiency and should be investigated. Natural menopause rarely occurs before 40 without an underlying cause.

**Q: Can I get pregnant during perimenopause?**
Yes. Women remain fertile — though with reduced fertility — throughout perimenopause until 12 months have passed without a period. Contraception is recommended until this point if pregnancy is not desired. Discuss options with your doctor, as some contraceptives also manage perimenopausal symptoms.

**Q: Will I know when I've hit menopause?**
Menopause is defined retrospectively: only after 12 consecutive months without a period can you say that the last period was "the menopause." Many women find this frustrating, particularly when late cycles occur during perimenopause. The symptoms — not the date — are what typically bring women to seek care.

**Q: Can lifestyle changes reduce hot flushes?**
Moderately. Avoiding known triggers (alcohol, hot drinks, spicy food), dressing in layers, and cooling the bedroom at night can reduce flush frequency and severity for some women. Regular aerobic exercise is associated with fewer and less severe vasomotor symptoms in observational studies. For severe symptoms, lifestyle changes alone are usually insufficient; hormone therapy or non-hormonal medications are more effective.

---

## Further Reading

- [NICE Clinical Guideline NG23: Menopause](https://www.nice.org.uk/guidance/ng23) — UK national clinical guidance
- [Australasian Menopause Society — Consumer Information](https://www.menopause.org.au/) — Australian evidence-based resources
- [The Menopause Society (NAMS) — Position Statements](https://www.menopause.org/) — North American consensus guidance
- [Jean Hailes for Women's Health — Menopause](https://www.jeanhailes.org.au/health-a-z/menopause) — Plain-language Australian resource
...
- [Anxiety: When Worry Becomes a Problem](/guides/anxiety)
- [Healthy Aging and Longevity Basics](/guides/aging-and-longevity-basics)
