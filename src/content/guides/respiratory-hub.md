...
faq:
  - q: "What conditions affect the respiratory system?"
    a: "The most common chronic respiratory conditions are asthma, COPD, and obstructive sleep apnoea. Common acute conditions include pneumonia and influenza. Symptoms such as shortness of breath and wheezing can arise from any of these, as well as from cardiac causes."
  - q: "When should I see a doctor for breathing issues?"
    a: "If you experience sudden, severe, or unexplained shortness of breath, wheezing, chest pain, or coughing up blood, seek urgent medical help immediately. Breathing problems that are worsening over days or that interfere with daily activity also warrant prompt medical assessment."
  - q: "Can lifestyle changes improve respiratory health?"
    a: "Yes. Stopping smoking is the most effective single step for preventing COPD and improving asthma control. Regular exercise, avoiding known allergens, maintaining a healthy weight, and reducing indoor air pollution also support lung health and improve outcomes in chronic respiratory conditions."
  - q: "What is the difference between asthma and COPD?"
    a: "Asthma is driven by airway inflammation and hypersensitivity — symptoms are episodic and largely reversible with treatment. COPD is a progressive condition caused primarily by smoking, producing permanent airflow limitation. Both cause breathlessness and wheeze, but treatment approaches differ significantly."
  - q: "When should I call emergency services for a breathing problem?"
    a: "Call emergency services immediately for sudden severe breathlessness at rest, lips or fingernails turning blue, a severe asthma attack not responding to your reliever inhaler, chest pain with breathlessness, or any sudden collapse. Do not attempt to drive yourself to hospital."
  - q: "What is sleep apnoea and how is it treated?"
    a: "Obstructive sleep apnoea occurs when the upper airway repeatedly collapses during sleep, causing breathing pauses. It results in fragmented sleep, daytime sleepiness, and over time raises blood pressure and cardiovascular risk. The most effective treatment is CPAP therapy, which keeps the airway open during sleep."
---
...
- [Asthma](/guides/asthma) — episodic airway inflammation with broadly reversible airflow obstruction; most people with asthma can achieve excellent symptom control with appropriate inhaler therapy
- [COPD](/guides/copd) — progressive, largely irreversible airflow limitation caused primarily by smoking or long-term inhaled irritants; stopping smoking is the single most effective treatment
...
- [Sleep Apnoea](/guides/sleep-apnoea) — repeated collapse of the upper airway during sleep, causing fragmented sleep, oxygen desaturation, and long-term cardiovascular risk
...
- [Shortness of Breath — When to Seek Urgent Help](/guides/shortness-of-breath) — covers the full spectrum of causes, from cardiac and pulmonary to metabolic and psychological
...
- These conditions often overlap with [heart and circulation](/guides/heart-circulation) issues — breathlessness and fatigue can be driven by either system.
- Stopping smoking is the **single most effective intervention** for preventing COPD and improving asthma control.
- Blood oxygen levels can be monitored at home with a pulse oximeter; see [Blood Oxygen Levels and Pulse Oximeters](/guides/blood-oxygen-pulse-oximeters) for guidance on interpreting readings.
...
→ [COPD](/guides/copd) | [Smoking and Tobacco Cessation](/guides/smoking-cessation)
...
- Chest pain with breathlessness — see [When to Seek Emergency Help for Chest Pain](/guides/when-to-seek-emergency-help-for-chest-pain)
...
See also: [Emergencies — Guide Hub](/guides/emergencies) | [Blood Oxygen Levels and Pulse Oximeters](/guides/blood-oxygen-pulse-oximeters)
...
**Q: What conditions affect the respiratory system?**
The most common chronic respiratory conditions are [asthma](/guides/asthma) (~262 million people globally), [COPD](/guides/copd) (~480 million people, the third leading cause of death worldwide), and obstructive [sleep apnoea](/guides/sleep-apnoea) (~1 billion people to varying degrees). Common acute conditions include pneumonia and influenza, covered in the [Infectious Diseases hub](/guides/infectious-diseases).

**Q: When should I see a doctor for breathing issues?**
If you experience sudden, severe, or unexplained [shortness of breath](/guides/shortness-of-breath), wheezing, chest pain, or coughing up blood, seek urgent medical help immediately — do not wait. Breathing problems that are gradually worsening over days, or that are interfering with normal daily activity, also warrant prompt medical assessment the same day.

**Q: Can lifestyle changes improve respiratory health?**
Yes. Stopping smoking is the most effective single step — it is the primary way to prevent [COPD](/guides/copd) and one of the most powerful tools for improving asthma control. See [Smoking and Tobacco Cessation](/guides/smoking-cessation) for evidence-based cessation strategies. Regular exercise, avoiding known allergens, maintaining a healthy weight, and reducing indoor air pollution all support lung health and improve outcomes across chronic respiratory conditions.

**Q: What is the difference between asthma and COPD?**
[Asthma](/guides/asthma) is driven by airway inflammation and hypersensitivity — symptoms are episodic and largely reversible with treatment. [COPD](/guides/copd) is a progressive condition caused primarily by smoking, producing permanent airflow limitation that worsens over years. Some people have features of both conditions simultaneously (asthma–COPD overlap syndrome). Distinguishing them matters because treatment approaches differ significantly — a correct diagnosis is the first step.
