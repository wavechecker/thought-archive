---
title: "Heavy Periods: When to Seek Help"
slug: "heavy-periods-when-to-seek-help"
...
schema:
  medicalCondition:
    ...
    description: "Abnormally heavy or prolonged uterine bleeding occurring at regular menstrual intervals. Clinically defined as blood loss exceeding 80 ml per cycle, but more practically assessed by impact on daily life and quality of life."
    alternateName:
      - "menorrhagia"
      - "heavy menstrual bleeding"
      - "HMB"
    ...
    sameAs:
      ...
      - "https://www.jeanhailes.org.au/health-a-z/periods/heavy-painful-periods"
faq:
  - q: "How do I know if my periods are too heavy?"
    a: "The clinical definition of heavy periods (more than 80 ml per cycle) is not easy to measure at home. In practice, seek assessment if you: soak through a pad or tampon every 1–2 hours for several consecutive hours; need to use two types of protection simultaneously; pass large blood clots (larger than a 50-cent coin); bleed for more than 7 days; or if heavy bleeding is interfering with your daily activities, work, social life, or sleep. Your experience of its impact on your quality of life is a valid reason to seek care."
  - q: "What causes heavy periods?"
    a: "The most common causes include uterine fibroids, adenomyosis, endometrial polyps, and hormonal imbalance (including PCOS and perimenopause). Bleeding disorders — particularly von Willebrand disease — are an underdiagnosed cause, especially in women who have had heavy periods since puberty. Less commonly, endometrial cancer must be considered in women over 40 with new or worsening heavy bleeding or intermenstrual bleeding."
  - q: "Can heavy periods cause anaemia?"
    a: "Yes. Heavy menstrual bleeding is the most common cause of iron deficiency anaemia in women of reproductive age worldwide. The body can compensate for months to years, but cumulative blood loss eventually depletes iron stores. Symptoms of iron deficiency include fatigue, reduced exercise tolerance, difficulty concentrating, restless legs, and feeling cold. Iron studies and a full blood count should be checked in any woman with heavy periods."
  - q: "What tests will I need?"
    a: "Initial investigations typically include a full blood count (to assess for anaemia) and iron studies, a pelvic ultrasound (to identify fibroids, polyps, or adenomyosis), and sometimes a coagulation screen and thyroid function. Pelvic examination and a review of your cycle history and its impact on daily life are part of the assessment. For women over 40 or with additional risk factors, endometrial assessment may be recommended."
  - q: "Is heavy bleeding always serious?"
    a: "Most heavy periods are caused by benign conditions — fibroids, adenomyosis, or hormonal imbalance — and are very treatable. However, heavy bleeding should always be assessed rather than simply tolerated, because: it significantly impairs quality of life; it causes preventable iron deficiency anaemia; it can be the presentation of treatable conditions; and, less commonly, it can indicate endometrial cancer. Heavy periods are not something that needs to be accepted as normal."
---
...
**Perimenopause** is a common cause of new or worsening heavy bleeding in women in their 40s. However, this should not be assumed without assessment to exclude other causes. See [Perimenopause: What to Expect](/guides/perimenopause-what-to-expect).

**PCOS** — anovulatory cycles cause irregular, sometimes heavy periods. See [PCOS: Understanding Polycystic Ovary Syndrome](/guides/pcos).
...
1. **Iron depletion** — iron stores (ferritin) fall but haemoglobin remains normal
2. **Iron-deficient erythropoiesis** — red cell production becomes impaired
3. **Iron deficiency anaemia** — haemoglobin falls and symptoms become apparent
...
See [Why Am I Always Tired?](/guides/why-am-i-always-tired) and [Restless Legs Syndrome](/guides/restless-legs-syndrome) for related iron deficiency content.
...
The most effective medical treatment for heavy periods. Releases a small amount of progesterone locally, causing the endometrial lining to thin. Reduces blood loss by 70–95% in most women. Also provides contraception. This is generally the first option offered to women wanting to preserve fertility or avoid surgery.

**Tranexamic acid**
Non-hormonal. Reduces blood loss by approximately 40–50% by inhibiting the breakdown of blood clots at the endometrial surface. Taken only during heavy days. Does not affect ovulation or fertility.

**NSAIDs (e.g. mefenamic acid, ibuprofen)**
Reduce blood loss by approximately 25–30% and also reduce associated period pain (dysmenorrhoea). Taken during menstruation only.

**Combined oral contraceptive pill**
Reduces blood loss, regulates cycles, and provides contraception. Approximately 40–50% reduction in blood loss. Not suitable for all women (history of VTE, smoking over 35, migraine with aura).

**Progestogens (norethisterone, medroxyprogesterone)**
Can slow or stop heavy periods; often used short-term while awaiting investigations or a longer-term solution.

### Surgical Treatments

**Endometrial ablation**
Destroys the endometrial lining using heat, microwave, or radiofrequency. Amenorrhoea in approximately 30% of women; significant reduction in 60–80%. Performed as a day procedure. Not suitable for women wanting future pregnancy.

**Hysteroscopic resection**
Removal of polyps or submucosal fibroids under direct vision. Highly effective for these specific structural causes.

**Uterine artery embolisation (UAE)**
Minimally invasive radiological procedure for symptomatic fibroids. Reduces fibroid blood supply, causing them to shrink. Preserves the uterus.

**Myomectomy**
Surgical removal of fibroids while preserving the uterus. Appropriate for women wanting to retain fertility.

**Hysterectomy**
Definitive treatment — removes the uterus, ending periods permanently. Reserved for cases where other treatments have failed or are not appropriate.
