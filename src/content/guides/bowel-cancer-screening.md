...
schema:
  medicalCondition:
    ...
    description: >-
      Bowel cancer screening uses non-invasive tests and colonoscopy to detect
      cancer or precancerous polyps before symptoms develop, when treatment is
      most effective.
    alternateName:
    ...
    symptoms:
      ...
      - Fatigue linked to occult bleeding
    possibleComplication:
      - Late-stage cancer due to missed or delayed diagnosis
      - Colonoscopy complications including bowel perforation (rare) and bleeding
      - Anxiety from false-positive test results
...
faq:
  - q: At what age should I start bowel cancer screening?
    a: >-
      Most national guidelines recommend starting at age 45–50 for people at
      average risk. Those with a family history of bowel cancer, genetic
      conditions such as Lynch syndrome or FAP, or long-standing inflammatory
      bowel disease may need to start earlier — your doctor can advise on the
      right schedule for you.
  - q: What is a FIT test and how accurate is it?
    a: >-
      The FIT (Faecal Immunochemical Test) detects hidden blood in a stool
      sample that may indicate cancer or polyps. It is non-invasive and done at
      home, but is not perfect — it can produce false positives and false
      negatives. A positive result requires follow-up with colonoscopy for
      definitive assessment.
  - q: What happens if my FIT test result is positive?
    a: >-
      A positive FIT result does not confirm cancer — it means blood was
      detected, which can have several causes including polyps, haemorrhoids, or
      benign inflammation. Your doctor will usually arrange a colonoscopy to
      examine the bowel directly, remove any suspicious tissue, or take a biopsy.
  - q: Can screening actually prevent bowel cancer, not just detect it?
    a: >-
      Yes. Colonoscopy allows doctors to identify and remove precancerous polyps
      before they develop into cancer, making it one of the most direct forms
      of cancer prevention available. The FIT test cannot remove polyps, but
      early detection leads to earlier and more effective treatment.
  - q: Is colonoscopy safe?
    a: >-
      Colonoscopy is generally safe, but carries small risks including bowel
      perforation (less than 1 in 1,000 procedures) and bleeding, particularly
      after polyp removal. The procedure is performed under sedation, so most
      people experience minimal discomfort. The risk of the procedure is far
      lower than the risk of undetected bowel cancer.
  - q: When should I see a doctor urgently rather than waiting for routine screening?
    a: >-
      Seek prompt medical assessment if you notice blood in your stool, a
      persistent unexplained change in bowel habits lasting more than two to
      three weeks, unexplained weight loss, or significant abdominal pain.
      These symptoms should be evaluated without delay — do not defer them to a
...
**Q: At what age should I start bowel cancer screening?**
A: Most national guidelines recommend starting at age 45–50 for people at average risk. If you have a family history of bowel cancer, Lynch syndrome, FAP, or long-standing inflammatory bowel disease, your doctor may recommend starting earlier and screening more frequently.

**Q: What is a FIT test and how accurate is it?**
A: The FIT (Faecal Immunochemical Test) detects hidden blood in a stool sample that may indicate cancer or polyps. It is non-invasive and done at home, but is not perfect — it can produce false positives and false negatives. A positive result always requires follow-up colonoscopy for definitive assessment.

**Q: What happens if my FIT test result is positive?**
A: A positive FIT result does not confirm cancer. Blood can be detected for several reasons, including polyps, haemorrhoids, or benign inflammation. Your doctor will usually arrange a colonoscopy to examine the bowel directly, remove suspicious tissue, or take a biopsy.

**Q: Can screening prevent bowel cancer, not just detect it?**
A: Yes. Colonoscopy allows doctors to identify and remove precancerous polyps before they develop into cancer — making it one of the most direct forms of cancer prevention available. The FIT test cannot remove polyps, but detecting cancer early leads to significantly better treatment outcomes.
