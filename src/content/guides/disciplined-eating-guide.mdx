...
draft: false
faq:
  - q: "What is disciplined eating?"
    a: "Disciplined eating means making food choices deliberately based on health outcomes — prioritising protein, fibre, and metabolic health — rather than following rigid rules, calorie counting apps, or social norms about 'clean' eating."
  - q: "Is disciplined eating the same as dieting?"
    a: "No. Dieting typically involves temporary restriction with an end goal. Disciplined eating is an ongoing, outcomes-focused approach. Flexibility is treated as a feature, not a failure."
  - q: "Can disciplined eating become unhealthy?"
    a: "Yes. When food rules become inflexible, generate fear or anxiety, or revolve around identity and moral judgement rather than health outcomes, the approach has shifted into dysfunction. The goal is health, not adherence."
  - q: "What should I eat for metabolic health?"
    a: "Core principles include prioritising protein and fibre, limiting ultra-processed foods, and eating in a way that supports stable energy and body composition. Specific food choices matter less than consistent overall patterns."
  - q: "How do I maintain healthy eating without becoming obsessive?"
    a: "Focus on outcomes — energy, biomarkers, physical function — rather than rules. Allow flexibility for social occasions. If eating habits cause significant distress or avoidance, discuss this with a dietitian or mental health professional."
---
...
- [Metabolic Health Basics](/guides/metabolic-health-hub)
...
- [Sleep and Metabolic Health: Why It Changes Appetite and Recovery](/guides/sleep)
...
- [Orthorexia: When Disciplined Eating Gets Pathologised](/posts/orthorexia-when-disciplined-eating-gets-pathologised)
