...
schema:
  medicalCondition:
    ...
    description: "A progressive neurodegenerative disease and the most common cause of dementia, characterised by amyloid plaque and tau tangle pathology beginning years before clinical symptom onset."
    alternateName:
      - "AD"
      - "Alzheimer dementia"
    ...
    riskFactors:
      - "Age over 65 years"
      - "Apolipoprotein E ε4 (APOE4) allele"
      - "Family history of Alzheimer's disease"
      - "Cardiovascular risk factors (hypertension, diabetes, obesity)"
      - "Traumatic brain injury"
      - "Low educational attainment and reduced cognitive reserve"
    symptoms:
      - "Progressive memory impairment (especially recent events)"
      - "Word-finding difficulties and language problems"
      - "Disorientation and confusion"
      - "Difficulty with planning, reasoning, and complex tasks"
      - "Behavioural and personality changes in later stages"
    possibleComplication:
      - "Severe functional decline requiring full-time care"
      - "Aspiration pneumonia (leading cause of death)"
      - "Falls and fractures from cognitive decline"
      - "Behavioural disturbances (agitation, wandering)"
    contagious: false
    sameAs:
