...
description: >-
  How CGMs and finger-prick meters work, who benefits from continuous
  monitoring, and how to use glucose data intelligently — whether you have
  Type 1 diabetes, Type 2 diabetes, prediabetes, or simply want to understand
...
schema:
  medicalCondition:
    name: Continuous Glucose Monitoring and Blood Glucose Testing
    description: >-
      Glucose monitoring tools — including continuous glucose monitors (CGMs)
      and finger-prick blood glucose meters — help people with diabetes and
      those at metabolic risk track blood sugar levels to guide treatment,
      lifestyle decisions, and safety.
    alternateName:
      - CGM vs BGM
    ...
    riskFactors:
      ...
      - High cardiovascular risk with glucose variability
    symptoms:
      - Hypoglycaemia (low blood glucose)
      - Hyperglycaemia (high blood glucose)
      - Glucose variability affecting energy, mood, and performance
    possibleComplication:
      - Severe hypoglycaemia if glucose levels are unmonitored
      - Alarm fatigue from poorly calibrated CGM alerts
      - Skin irritation or infection at sensor insertion sites
    contagious: false
    sameAs:
      - 'https://www.who.int/'
      - 'https://medlineplus.gov/'
faq:
  - q: Are CGMs only for people with Type 1 diabetes?
    a: >-
      No. CGMs are increasingly used in Type 2 diabetes management, prediabetes
      monitoring, and by people without diabetes who want to understand how food
      and activity affect their glucose. Clinical access and subsidy vary by
      country and diagnosis.
  - q: How accurate are CGMs compared to finger-prick meters?
    a: >-
      CGMs measure glucose in interstitial fluid, which can lag 5–15 minutes
      behind blood glucose during rapid changes. For most routine monitoring,
      accuracy is clinically adequate. For critical decisions — treating a severe
      hypo, driving, or dosing insulin during illness — confirming with a
      finger-prick meter is recommended.
  - q: Do CGMs require a prescription?
    a: >-
      This depends on your country. In many countries, CGMs require a
      prescription and may be subsidised for people with Type 1 or
      insulin-treated Type 2 diabetes. Some consumer-facing CGMs (e.g., Abbott
      Lingo) are now available without prescription for general wellness use.
  - q: What does "time in range" mean and why does it matter?
    a: >-
      Time in range (TIR) is the percentage of time glucose stays within a
      target band — typically 3.9–10 mmol/L for most people with diabetes. It
      is increasingly used alongside HbA1c as a key measure of control, because
      it captures variability and fluctuations that a single average value
      cannot.
  - q: Can I use CGM data to improve my lifestyle even without diabetes?
    a: >-
      Yes. Tracking glucose responses to different meals, exercise, sleep, and
      stress can provide meaningful insight for people without a formal
      diagnosis. Interpret data in context and ideally with clinical guidance —
      individual glucose variation is normal, and not every spike signals a
      problem.
---
...
**Prediabetes** — CGMs can reveal the degree of glucose variability and individual food responses before a formal diabetes diagnosis. This is an emerging area, with increasing evidence that early awareness supports prevention. See our guide on [Prediabetes](/guides/prediabetes) for context on risk and prevention.
...
**Q: Are CGMs only for people with Type 1 diabetes?**
A: No. CGMs are increasingly used in Type 2 diabetes management, prediabetes monitoring, and by people without diabetes who want to understand how food and activity affect their glucose. Clinical access and subsidy vary by country and diagnosis.

**Q: How accurate are CGMs compared to finger-prick meters?**
A: CGMs measure glucose in interstitial fluid, which can lag 5–15 minutes behind blood glucose during rapid changes. For most routine monitoring, accuracy is clinically adequate. For critical decisions — treating a severe hypo, driving, or dosing insulin during illness — confirming with a finger-prick meter is recommended.

**Q: Do CGMs require a prescription?**
A: This depends on your country. In many countries, CGMs require a prescription and may be subsidised for people with Type 1 or insulin-treated Type 2 diabetes. Some consumer-facing CGMs (e.g., Abbott Lingo) are available without prescription for general wellness use.

**Q: What does "time in range" mean and why does it matter?**
A: Time in range (TIR) is the percentage of time glucose stays within a target band — typically 3.9–10 mmol/L for most people with diabetes. It is increasingly used alongside HbA1c because it captures variability and fluctuations that a single average value cannot.

**Q: Can I use CGM data to improve my lifestyle even without diabetes?**
A: Yes. Tracking glucose responses to different meals, exercise, sleep, and stress can provide meaningful insight even for people without a formal diagnosis. Individual glucose variation is normal — not every spike signals a problem. Interpret data in context and ideally with clinical input.
