...
faq:
  - q: "What does SPF measure?"
    a: "SPF measures protection against UVB radiation specifically. SPF 30 blocks approximately 97% of UVB; SPF 50 blocks approximately 98%. Broad-spectrum labelling is required to confirm UVA protection is also included."
  - q: "What is the difference between UVA and UVB radiation?"
    a: "UVB causes sunburn and is the primary driver of most skin cancers. UVA penetrates more deeply, drives photoaging — wrinkles and pigmentation — and contributes to melanoma risk. Both are present year-round and both need protection."
  - q: "Are mineral and chemical sunscreens equally safe?"
    a: "Both are effective and have good safety profiles. Mineral sunscreens (zinc oxide, titanium dioxide) sit on the skin surface and reflect UV. Chemical sunscreens absorb UV and convert it to heat. The most important factor is consistent correct use."
  - q: "How much sunscreen should I apply?"
    a: "Most people apply too little. Standard guidance is approximately one teaspoon for the face and neck, and proportionally more for exposed body areas. Underapplication significantly reduces effective SPF."
  - q: "Does sunscreen need to be reapplied during the day?"
    a: "Yes. Reapplication every two hours is required for sustained outdoor protection, and after swimming or sweating. Single morning application is insufficient for prolonged sun exposure."
---
