...
draft: false
faq:
  - q: "What are the most important safety concerns with GLP-1 medications like Ozempic?"
    a: "Key concerns include muscle loss (especially with rapid weight loss), gastrointestinal side effects (nausea, vomiting, delayed gastric emptying), and contraindication in people with a personal or family history of medullary thyroid carcinoma. These drugs should be used under medical supervision."
  - q: "What happens if I stop Ozempic suddenly?"
    a: "Appetite typically returns and weight regain is common — often substantial within months. Most gastrointestinal side effects resolve. Gradual tapering rather than abrupt cessation is generally preferred."
  - q: "Does Ozempic cause muscle loss?"
    a: "GLP-1 medications reduce total body weight, and a significant proportion may be lean muscle mass unless protein intake is adequate and resistance training is maintained. This is particularly concerning in older adults already at risk of sarcopenia."
  - q: "Is it safe to use GLP-1 medications off-label from informal sources?"
    a: "No. Compounded or counterfeit versions of GLP-1 medications carry risks of unknown quality, dosing errors, and contamination. These medications should only be obtained through a licensed prescriber and pharmacy."
  - q: "What medications or conditions interact with GLP-1 drugs?"
    a: "GLP-1 medications slow gastric emptying, which can affect absorption of oral medications. People with a history of pancreatitis, medullary thyroid carcinoma, or MEN2 syndrome should not use these drugs. A prescriber should review your full medical history and medication list."
---
