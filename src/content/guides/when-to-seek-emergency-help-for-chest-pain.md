...
faq:
  ...
  - q: "If symptoms improve, can I skip care?"
    a: "No. Chest pain that resolves may indicate unstable angina — a direct warning sign of an impending heart attack. Get checked the same day even if you feel completely better."
  - q: "What is the difference between a heart attack and angina?"
    a: "Angina is chest pain from temporarily reduced blood flow to the heart, usually relieved by rest or medication within minutes. A heart attack involves a more severe or prolonged blockage that does not fully resolve with rest. If pain persists, treat it as a heart attack."
  - q: "Should I take aspirin before the ambulance arrives?"
    a: "Chew (do not swallow whole) one adult aspirin (300–325 mg) if you are not allergic and have no contraindications. Do not substitute ibuprofen — aspirin has a specific anti-clotting action that ibuprofen does not replicate."
  - q: "Is chest pain in women different?"
    a: "Women may experience less typical symptoms — jaw pain, back pain, nausea, or fatigue — without prominent chest pain. These presentations are just as serious and warrant the same urgency."
  - q: "What if I'm not sure it's serious?"
    a: "Call emergency services and describe your symptoms. Let professionals decide. A false alarm is always preferable to a delayed response to a real emergency."
  - q: "Can anxiety cause chest pain?"
    a: "Yes — but cardiac and other serious causes must be ruled out first. Anxiety-related chest pain tends to occur alongside tingling, a sense of panic, and breathlessness, and often improves with calm breathing. This is not a reliable enough distinction to skip medical evaluation."
  - q: "What is a pulmonary embolism and how does it differ from a heart attack?"
    a: "A pulmonary embolism (PE) is a blood clot in the lung arteries. It typically causes sudden sharp chest pain that worsens when breathing in, accompanied by breathlessness and sometimes a fast heart rate. Unlike a heart attack, it may not produce the classic squeezing pressure. Both are emergencies requiring immediate care."
---
...
1. **Call emergency services immediately** if you have any red-flag symptoms listed above.
2. **Sit or lie down** in the most comfortable position. Do not exert yourself.
3. **Do not drive yourself** — call an ambulance, or have someone else call if you cannot.
4. **Chew (do not swallow whole) one adult aspirin (300–325 mg)** unless you are allergic, on anticoagulants that preclude it, or have been told not to take aspirin by a doctor.
5. **Stay on the phone** with emergency services and follow their instructions closely.
6. **Unlock the front door** if you are alone so paramedics can enter.
7. **Gather your medication list** — or ask someone nearby to locate it.
...
- [National Heart, Lung, and Blood Institute — Angina](https://www.nhlbi.nih.gov/health/angina)
- [CDC — Heart Attack: Know the Warning Signs](https://www.cdc.gov/heartdisease/heart_attack.htm)
