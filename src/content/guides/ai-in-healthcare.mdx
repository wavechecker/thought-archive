...
faq:
  ...
  - q: "Does AI replace doctors?"
    a: "No. Current AI systems assist clinicians rather than replace them. They are most effective when used alongside human judgement and specialist expertise, not as standalone decision-makers."
  - q: "How accurate is AI at diagnosing medical conditions?"
    a: "Performance varies widely by task. Some AI systems match specialist accuracy on specific imaging tasks. However, accuracy in controlled trials does not always translate to improved patient outcomes in real-world practice."
  - q: "What are the risks of AI in healthcare?"
    a: "Key risks include algorithmic bias, over-reliance on AI at the expense of clinical reasoning, errors in unusual cases, and potential for patient harm when systems are deployed without adequate validation or oversight."
  - q: "Is my medical data used to train AI?"
    a: "Hospitals and healthcare organisations may use de-identified or consent-based patient data to develop AI models. Privacy frameworks and local regulations govern how medical data can be used in this way."
---
...
- [Stroke Symptoms](/guides/stroke-symptoms-fast-response)
