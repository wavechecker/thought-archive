...
schema:
  medicalCondition:
    ...
    description: "A malignant tumour of the colon or rectum highly amenable to early detection through population screening with faecal immunochemical testing (FIT) or colonoscopy, with survival strongly correlated to stage at detection."
    alternateName:
      - "Bowel cancer"
      - "Colon cancer"
      - "Rectal cancer"
    ...
    riskFactors:
      ...
      - "Diet high in red and processed meat, obesity, smoking, and alcohol"
    symptoms:
    ...
    possibleComplication:
      - "Locally advanced or metastatic disease if detected late"
      - "Bowel obstruction"
      - "Colonoscopy-related perforation (rare)"
    contagious: false
    sameAs:
