---
title: "Testicular Cancer: What Men Need to Know"
slug: "testicular-cancer-overview"
description: "An evidence-based overview of testicular cancer — a painless lump on the testicle, ultrasound diagnosis, tumour markers, staging, treatment, and prognosis."
category: "Cancer"
publishDate: "2026-05-20"
updatedDate: "2026-05-20"
tags: ["testicular cancer", "cancer", "men's health", "oncology", "fertility", "tumour markers", "orchidectomy", "testicle", "testicular lump", "lump", "scrotal swelling"]
draft: false
faq:
  - q: "How common is testicular cancer?"
    a: "Testicular cancer is the most common cancer in men aged 15 to 35, but overall it is uncommon — accounting for around 1–2% of all male cancers. In most countries, approximately 6–8 men per 100,000 are diagnosed each year."
  - q: "Is a painless lump always cancer?"
    a: "Not necessarily — lumps in or around the testicle can have many causes, including cysts (epididymal cysts), varicocele (dilated veins), or hydrocele (fluid collection). However, any new, persistent lump on the testicle itself should be assessed by a doctor promptly. A painless, firm lump on the testicle is a typical early sign of testicular cancer."
  - q: "What happens to fertility after treatment?"
    a: "Surgery to remove one testicle (orchidectomy) usually preserves adequate testosterone production and fertility if the other testicle is normal. Chemotherapy and radiotherapy can affect sperm production temporarily or permanently. Sperm banking before systemic treatment is recommended for men who may want biological children in the future."
  - q: "What are the chances of cure?"
    a: "Testicular cancer has one of the highest cure rates of any solid cancer. When caught at stage I (confined to the testicle), the 5-year survival rate exceeds 99%. Even with metastatic disease, many men are cured with platinum-based chemotherapy. Overall survival across all stages is around 95–96%."
  - q: "Can testicular cancer spread before it is noticed?"
    a: "It can. Some men first notice swelling, backache (from lymph node involvement), or breathlessness (from lung spread) rather than a testicular lump. This is why any unusual change — especially a painless testicular lump or heaviness — should not be ignored or self-monitored for weeks without medical assessment."
  - q: "Does an undescended testicle increase risk?"
    a: "Yes. Cryptorchidism (undescended testicle), whether corrected or not, increases the lifetime risk of testicular cancer. Men with a history of cryptorchidism should mention this to their doctor and be aware of the symptoms to watch for."
---
...
- [EAU Guidelines on Testicular Cancer](https://uroweb.org/guidelines/testicular-cancer)
