...
slug: "endometriosis"
description: >-
  A comprehensive guide to endometriosis — covering symptoms, the diagnostic
  delay problem, pelvic pain, fertility implications, hormonal and surgical
  treatments, and living with a chronic condition.
...
schema:
  medicalCondition:
    name: "Endometriosis"
    description: >-
      A chronic inflammatory condition in which endometrial-like tissue grows
      outside the uterus — commonly on the ovaries, fallopian tubes, bowel,
      bladder, and pelvic peritoneum. It affects an estimated 1 in 9 women of
      reproductive age, is a leading cause of chronic pelvic pain and
      anovulatory infertility, and carries a median diagnostic delay of
      7–10 years.
    alternateName:
      - "endo"
...
faq:
  - q: "What is endometriosis?"
    a: >-
      Endometriosis is a chronic condition in which tissue similar to the lining
      of the uterus (the endometrium) grows outside the uterus. This tissue
      responds to menstrual hormones — swelling, breaking down, and bleeding —
      but has no way to leave the body. The result is inflammation, scar tissue
      (adhesions), and often significant pain. Common sites include the ovaries,
      fallopian tubes, bowel, bladder, and pelvic lining. It affects an
      estimated 1 in 9 women of reproductive age.
  - q: "Why does endometriosis take so long to diagnose?"
    a: >-
      The average diagnostic delay for endometriosis is 7–10 years. Several
      factors contribute: painful periods are often normalised by healthcare
      providers and patients themselves; endometriosis cannot be seen on
      standard imaging (ultrasound does not reliably detect non-cystic disease);
      and definitive diagnosis has traditionally required laparoscopy. Symptoms
      also overlap with other conditions such as irritable bowel syndrome and
      interstitial cystitis. Awareness is improving, and clinical diagnosis
      (without laparoscopy) is increasingly accepted for initiating treatment.
  - q: "Does endometriosis always cause pain?"
    a: >-
      No. There is a poor correlation between the anatomical extent of
      endometriosis (its staging) and symptom severity. Some women with
      extensive disease have minimal pain; others with minimal deposits have
      severe, debilitating symptoms. Pain is a product of inflammation,
      nerve involvement, and central sensitisation — not simply the amount of
      tissue present. Some women discover endometriosis incidentally during
      investigations for infertility, with no significant pain history.
  - q: "Can endometriosis be cured?"
    a: >-
      There is currently no cure for endometriosis. Treatment is focused on
      symptom management, preserving fertility where relevant, and improving
      quality of life. Hormonal treatments suppress the disease and reduce pain
      during use but do not eradicate it, and symptoms typically return when
      treatment stops. Surgery can remove deposits and adhesions and may
      provide sustained relief, but endometriosis recurs after surgery in
      many women — estimated at 20–40% within 5 years. A long-term management
      approach is necessary.
  - q: "Does endometriosis affect fertility?"
    a: >-
      Yes, in a significant proportion of women with endometriosis — though many
      women with endometriosis conceive without difficulty. Endometriosis can
      affect fertility through ovarian damage (endometriomas destroy follicular
      reserve), distortion of pelvic anatomy by adhesions, altered tubal
      function, and an adverse uterine environment for implantation. Women with
      endometriosis who are trying to conceive should discuss the timeline and
      options with a specialist, as early assessment of ovarian reserve may
      be warranted.
  - q: "What hormonal treatments are available for endometriosis?"
    a: >-
      All hormonal treatments work by suppressing or stabilising oestrogen
      levels, which reduces the activity of endometrial-like tissue. Options
      include: the combined oral contraceptive pill (continuous use, to suppress
      periods); progestogens (oral norethisterone, the Mirena IUD, desogestrel);
      GnRH agonists (Zoladex, Lupron — induce temporary menopause; used
      short-term with add-back HRT); GnRH antagonists (elagolix, relugolix —
      newer, similar effect to agonists but without an initial flare);
      and the levonorgestrel IUD (Mirena), which has strong evidence for
      reducing endometriosis-related pain and heavy bleeding.
  - q: "What is adenomyosis and how is it different from endometriosis?"
    a: >-
      Adenomyosis is a distinct but related condition in which endometrial
      glands and stroma grow within the muscular wall of the uterus (the
      myometrium), rather than outside the uterus. It causes heavy periods,
      cramping, and an enlarged, tender uterus. The two conditions frequently
      co-exist — estimates suggest 20–30% of women with endometriosis also have
      adenomyosis. Adenomyosis is diagnosed on ultrasound or MRI and does not
      require laparoscopy. Treatment overlaps with endometriosis management,
      including the Mirena IUD and, for definitive treatment, hysterectomy.
---
...
1. **Ovarian damage** — endometriomas reduce ovarian reserve (AMH levels)
2. **Pelvic adhesions** — distort tubal anatomy and impair egg pickup
3. **Peritoneal environment** — inflammatory mediators may impair sperm function and implantation
4. **Uterine receptivity** — deep infiltrating endometriosis may impair implantation
...
- [ESHRE Endometriosis Guideline (2022)](https://www.eshre.eu/Guidelines-and-Legal/Guidelines/Endometriosis-guideline) — European Society of Human Reproduction and Embryology clinical guideline
- [Endometriosis Australia — Patient Resources](https://www.endometriosisaustralia.org/) — Australian patient support and information
- [NHS — Endometriosis](https://www.nhs.uk/conditions/endometriosis/) — UK national guidance
- [National Endometriosis Clinical Reference Group — Australian Clinical Practice Guideline](https://www.health.gov.au/resources/publications/national-action-plan-for-endometriosis) — Australian federal action plan
...
- [Depression: What It Is and How It's Treated](/guides/depression)
- [Mental Health: An Overview](/guides/mental-health)
