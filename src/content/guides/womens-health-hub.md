...
faq:
  - q: "What are the most important health screenings for women?"
    a: "Key screenings include cervical cancer screening (HPV-based, starting at 25), breast cancer screening with mammography (from around 40–50 depending on national guidelines), bone density testing (from age 65, or earlier after early menopause or with fracture risk factors), and regular blood pressure and cholesterol checks from midlife. If you have a family history of ovarian or breast cancer, genetic counselling may be appropriate."
  - q: "What are the main hormonal changes women experience across life?"
    a: "Women's hormonal health changes significantly across three major transitions: puberty, the reproductive years, and the menopausal transition. During perimenopause and menopause, oestrogen and progesterone levels fluctuate then decline, driving a wide range of symptoms including hot flushes, sleep disruption, mood changes, and genitourinary changes. Understanding these phases helps women make informed decisions about symptom management and preventive health."
  - q: "When should I seek help for menstrual problems?"
    a: "Seek medical advice if periods are very heavy (soaking a pad or tampon hourly for several hours), last longer than 7 days, are accompanied by severe pain, have changed significantly in pattern, occur more frequently than every 21 days, or if you experience bleeding between periods or after sex. Irregular periods in your 40s may indicate perimenopause but should be assessed to exclude other causes."
  - q: "Is hormone therapy (HRT) safe?"
    a: "For most healthy women under 60, or within 10 years of their final period, the benefits of hormone therapy typically outweigh the risks. Modern formulations — particularly transdermal oestrogen — carry lower risks than older preparations. Decisions should be made individually with your doctor, weighing symptoms, personal health history, and values. See our full HRT guide for a detailed breakdown."
---
...
### [Cervical Screening by Age: What Tests You Need and When](/guides/cervical-screening-by-age)
...
### [Cervical Cancer Screening Explained: HPV Testing and Self-Collection](/guides/cervical-cancer-screening-hpv-self-testing)
...
### [Mammography and Breast Cancer Screening: What You Need to Know](/guides/mammography-breast-screening)
...
### [Breast Cancer — Overview and Hub](/guides/breast-cancer)
