...
faq:
  ...
  - q: "Can AI diagnose me?"
    a: "No. Current AI tools are not validated for individual diagnosis. They can explain conditions and suggest questions to ask your doctor, but they cannot examine you, order tests, or assess your personal history."
  - q: "What health topics are AI tools most useful for?"
    a: "AI tools work reasonably well for explaining medical concepts, summarising condition overviews, describing common treatments, and helping patients prepare questions for appointments."
  - q: "What should I be cautious about with AI health answers?"
    a: "AI tools can produce plausible-sounding but inaccurate information (hallucinations), may not reflect the most current evidence, and cannot account for your individual clinical history or examination findings."
  - q: "How does AI health information differ from a doctor's advice?"
    a: "Clinicians assess you personally, perform examinations, order tests, carry professional accountability, and apply current clinical guidelines. AI tools provide general information without individual assessment or clinical accountability."
---
