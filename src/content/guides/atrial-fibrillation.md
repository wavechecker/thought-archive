...
schema:
  medicalCondition:
    ...
    description: "Atrial fibrillation (AF or AFib) is the most common sustained cardiac arrhythmia, in which the upper chambers of the heart (atria) beat chaotically and out of sync with the lower chambers, causing an irregular pulse and increasing stroke risk."
    alternateName:
      - "AF"
      - "AFib"
      - "A-fib"
...
faq:
  - q: "What is atrial fibrillation (AFib)?"
    a: "Atrial fibrillation (AFib or AF) is the most common heart rhythm disorder. The upper chambers of the heart beat chaotically and out of sync with the lower chambers, producing an irregular pulse. It increases the risk of stroke, heart failure, and other complications, and requires medical management."
  - q: "What does atrial fibrillation feel like?"
    a: "Many people notice palpitations — a fluttering, racing, or irregular heartbeat. Others experience shortness of breath, fatigue, dizziness, or reduced exercise tolerance. Some people have no symptoms at all and are only diagnosed during a routine check."
  - q: "Why does AFib increase stroke risk?"
    a: "When the atria fibrillate chaotically, blood can pool and form clots. If a clot travels to the brain, it causes a stroke. People with AFib are 4–5 times more likely to have a stroke than those with normal heart rhythm. Anticoagulant therapy (blood thinners) greatly reduces this risk."
  - q: "When should I seek emergency care?"
    a: "Call emergency services immediately if you experience: sudden severe chest pain, sudden shortness of breath at rest, palpitations with dizziness or fainting, or any sudden weakness, speech difficulty, or face drooping (possible stroke). A new or worsening irregular heartbeat also warrants prompt medical review."
  - q: "Can AFib be cured?"
    a: "Some people achieve long-term normal rhythm through catheter ablation or cardioversion, but many require ongoing medication. Management depends on whether AFib is paroxysmal (comes and goes), persistent, or permanent. Lifestyle changes — weight loss, treating sleep apnoea, reducing alcohol — also improve outcomes."
  - q: "What medications are used for AFib?"
    a: "Treatment falls into two categories: rate control (slowing the heart rate with beta blockers, calcium channel blockers, or digoxin) and rhythm control (restoring normal rhythm with antiarrhythmic drugs). Most people with AFib also need anticoagulants to reduce stroke risk."
---
...
**Q: What is AFib?**
Atrial fibrillation is the most common heart rhythm disorder — chaotic electrical activity in the upper chambers causes an irregular pulse and raises stroke risk significantly.

**Q: Why does AFib increase stroke risk?**
Blood pools in the chaotically beating atria, forming clots. If a clot travels to the brain, it causes a stroke. Anticoagulants reduce this risk substantially.

**Q: Can lifestyle changes help?**
Yes. Weight loss, treating sleep apnoea, reducing alcohol, and controlling blood pressure can reduce AFib burden and sometimes prevent progression.

**Q: Can AFib be cured?**
Catheter ablation restores normal rhythm in many people, particularly with paroxysmal AFib. It's not a guaranteed cure and episodes can recur.
...
- [European Society of Cardiology — Atrial Fibrillation](https://www.escardio.org/Patients/Patient-sections/Atrial-fibrillation)
- [Heart Foundation — Atrial Fibrillation](https://www.heartfoundation.org.au/heart-health-education/atrial-fibrillation)
