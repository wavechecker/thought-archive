---
title: "Heart Failure: Symptoms, Causes, Diagnosis, and Treatment"
slug: "heart-failure-overview"
description: "A comprehensive patient guide to heart failure — what it is, why the heart does not stop, types (HFrEF and HFpEF), symptoms, causes, diagnosis, treatment, and when to seek help."
...
schema:
  medicalCondition:
    name: "Heart Failure"
    description: "Heart failure is a clinical syndrome in which the heart cannot pump enough blood to meet the body's demands, or can only do so at abnormally high filling pressures. It causes breathlessness, fatigue, and fluid retention, and requires ongoing medical management."
    alternateName:
      - "Congestive heart failure"
      - "CHF"
      - "Cardiac failure"
    ...
    riskFactors:
      ...
      - "Chemotherapy or radiotherapy affecting the heart"
    symptoms:
      - "Shortness of breath on exertion or at rest"
      - "Breathlessness when lying flat (orthopnoea)"
      - "Waking at night breathless (paroxysmal nocturnal dyspnoea)"
      - "Ankle and leg swelling (peripheral oedema)"
      - "Rapid unexplained weight gain"
      - "Fatigue and reduced exercise tolerance"
      - "Persistent cough or wheeze"
    possibleComplication:
      - "Hospitalisation for acute decompensation"
      - "Kidney failure (cardiorenal syndrome)"
      - "Atrial fibrillation and ventricular arrhythmias"
      - "Sudden cardiac death"
      - "Cachexia and severe functional decline"
    contagious: false
    sameAs:
...
faq:
  - q: "What is heart failure?"
    a: "Heart failure means the heart is unable to pump enough blood to meet the body's needs, or can only do so at abnormally high pressures. It does not mean the heart has stopped — it means the heart's pumping function is weakened or stiffened. It is a serious but manageable chronic condition."
  - q: "What is the difference between HFrEF and HFpEF?"
    a: "HFrEF (heart failure with reduced ejection fraction) occurs when the heart muscle is weakened and pumps less blood per beat — typically defined as an ejection fraction below 40%. HFpEF (heart failure with preserved ejection fraction) occurs when the heart muscle is stiff and does not relax properly between beats, even though it contracts normally. HFpEF is increasingly common, especially in older adults with high blood pressure or diabetes."
  - q: "What causes heart failure?"
    a: "The most common causes are coronary artery disease (narrowed arteries, heart attack), high blood pressure, and atrial fibrillation. Diabetes, valve disease, cardiomyopathy, excessive alcohol use, and some chemotherapy drugs can also cause or worsen heart failure."
  - q: "How is heart failure diagnosed?"
    a: "Diagnosis typically involves an echocardiogram (ultrasound of the heart), a blood test for BNP or NT-proBNP (markers of heart strain), an ECG, and a chest X-ray. These confirm whether the heart is enlarged, weak, or stiff, and how much strain it is under."
  - q: "Can heart failure be treated?"
    a: "Yes. Modern medicines — particularly ACE inhibitors or ARBs (or sacubitril/valsartan), beta blockers, mineralocorticoid receptor antagonists, and SGLT2 inhibitors — significantly improve symptoms and reduce death in HFrEF. Diuretics relieve fluid build-up. HFpEF is managed mainly by treating underlying causes and SGLT2 inhibitors. Most people with heart failure can live active, fulfilling lives with the right treatment."
  - q: "What symptoms should prompt emergency care?"
    a: "Call emergency services immediately for: sudden severe shortness of breath at rest, chest pain, rapid weight gain (more than 2 kg in 24–48 hours), severe ankle swelling, confusion, blue lips or fingertips, or fainting. Do not wait for a scheduled appointment."
  - q: "What is cardiac rehabilitation and does it help with heart failure?"
    a: "Cardiac rehabilitation is a supervised programme of exercise, education, and psychological support. It is beneficial for many people with heart failure — improving exercise capacity, quality of life, and reducing hospital admissions. Ask your cardiologist or GP whether a cardiac rehab programme is appropriate for you."
---
...
Weighing yourself each morning (after urinating, before eating) is one of the most important self-management tools. A gain of 2 kg or more over 24–48 hours often indicates fluid retention and warrants contacting your GP or heart failure nurse. See also: [Heart Failure Warning Signs](/guides/heart-failure-warning-signs)
...
[Cardiac rehabilitation](/guides/cardiac-rehabilitation) programmes designed for heart failure are available in most Australian states. Ask your cardiologist or GP for a referral.
...
See the full guide: [Heart Failure Warning Signs: When Symptoms Need Urgent Care](/guides/heart-failure-warning-signs)

---

## FAQ

**Q: Does heart failure mean my heart will stop?**
No. Heart failure means the heart's pumping function is impaired — not that it is about to stop. With appropriate treatment, most people with heart failure live for many years.

**Q: What is ejection fraction?**
Ejection fraction (EF) is the percentage of blood pumped out of the left ventricle with each beat. A normal EF is around 55–70%. In HFrEF, EF is below 40%. It is measured by echocardiogram.

**Q: Can heart failure be reversed?**
In some cases, yes. If caused by a reversible trigger (uncontrolled blood pressure, tachycardia from AF, alcohol, or certain medicines), the heart can recover significant function when the cause is treated. In most cases, the structural changes persist but can be stabilised.

**Q: Are SGLT2 inhibitors only for diabetics?**
No. SGLT2 inhibitors such as dapagliflozin and empagliflozin are now approved for heart failure regardless of whether the person has diabetes. They reduce hospitalisations and improve outcomes.

**Q: What is sacubitril/valsartan (Entresto)?**
Sacubitril/valsartan (brand name Entresto) is an ARNI — a combination of an ARB (valsartan) and a neprilysin inhibitor (sacubitril). It is more effective than ACE inhibitors alone at reducing hospitalisation and death in HFrEF, and is now preferred where tolerated.

**Q: Can I exercise with heart failure?**
Yes, for most people with stable heart failure. Supervised exercise — particularly through cardiac rehabilitation — is recommended and improves quality of life and reduces hospital admissions. Always discuss your exercise plan with your care team first.

---

## Further Reading

- [ESC 2021 Guidelines for the Diagnosis and Treatment of Acute and Chronic Heart Failure](https://www.escardio.org/Guidelines/Clinical-Practice-Guidelines/Acute-and-Chronic-Heart-Failure) — European Society of Cardiology clinical guidelines
- [AHA/ACC/HFSA 2022 Guideline for the Management of Heart Failure](https://www.jacc.org/doi/10.1016/j.jacc.2021.12.012) — American guideline covering diagnosis, pharmacotherapy, and devices
- [NHS — Heart Failure](https://www.nhs.uk/conditions/heart-failure/) — UK patient information on symptoms, treatment, and living with heart failure
- [Heart Foundation Australia — Heart Failure](https://www.heartfoundation.org.au/heart-health-education/heart-failure) — Australian patient resources and support information
