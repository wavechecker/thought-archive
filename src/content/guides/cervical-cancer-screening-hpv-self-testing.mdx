...
schema:
  medicalCondition:
    ...
    description: "A malignant tumour of the cervix arising from persistent high-risk HPV infection, preventable through vaccination and detectable at pre-invasive stages through HPV testing or Pap smears."
    alternateName:
      - "Cervical carcinoma"
      - "Cancer of the cervix"
    riskFactors:
      - "Persistent infection with high-risk HPV types (especially HPV 16 and 18)"
      - "Unvaccinated or incomplete HPV vaccination"
    ...
    symptoms:
      ...
      - "Often asymptomatic at pre-invasive and early invasive stages"
    possibleComplication:
      - "Locally advanced cancer spreading to bladder, rectum, and lymph nodes"
      - "Distant metastasis"
      - "Infertility from radical surgical treatment"
