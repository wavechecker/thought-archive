...
slug: "pcos"
description: >-
  A patient-focused guide to polycystic ovary syndrome (PCOS) — covering
  symptoms, the Rotterdam diagnostic criteria, insulin resistance, fertility,
  metabolic health, and treatment options.
...
schema:
  medicalCondition:
    ...
    description: >-
      A common endocrine disorder characterised by hyperandrogenism, ovulatory
      dysfunction, and polycystic ovarian morphology on ultrasound. It affects
      approximately 8–13% of reproductive-age women and is a leading cause of
      anovulatory infertility. PCOS has significant metabolic and cardiovascular
...
faq:
  - q: "What is PCOS?"
    a: >-
      ...
      roughly 1 in 10 women of reproductive age. It involves a combination of
      excess androgen activity (causing symptoms like irregular periods, acne,
      and excess hair growth), ovulatory dysfunction, and — in many cases —
      insulin resistance. Despite the name, you do not need to have cysts on
      your ovaries to be diagnosed with PCOS. The condition is diagnosed using
      the Rotterdam criteria, which require two of three features to be present.
  - q: "What are the Rotterdam criteria?"
    a: >-
      The Rotterdam criteria define PCOS by the presence of two or more of:
      (1) irregular or absent ovulation (anovulation), typically causing
      infrequent or absent periods; (2) clinical or biochemical signs of
      hyperandrogenism, such as acne, hirsutism (excess hair), or elevated
      androgens on a blood test; and (3) polycystic ovarian morphology on
      ultrasound (12 or more follicles in at least one ovary, or increased
      ovarian volume). Other causes of these features must be excluded before
      a diagnosis is confirmed.
  - q: "Does PCOS affect fertility?"
    a: >-
      PCOS is one of the most common causes of difficulty conceiving, primarily
      because irregular ovulation means fewer opportunities for conception each
      year. However, most women with PCOS can conceive, often with support. For
      women seeking pregnancy, first-line approaches include lifestyle
      modification (especially weight loss if overweight), letrozole or
      clomiphene citrate for ovulation induction, and metformin. IVF may be
      needed if other approaches are unsuccessful. Many women with PCOS
      conceive without medical assistance, particularly if their cycles are only
      mildly irregular.
  - q: "What is the link between PCOS and diabetes?"
    a: >-
      Insulin resistance is present in approximately 70% of women with PCOS,
      regardless of weight. It drives excess androgen production by the ovaries
      (as insulin stimulates ovarian testosterone secretion) and elevates the
      risk of type 2 diabetes. Women with PCOS have a 3–7 fold increased risk
      of developing type 2 diabetes compared with women without PCOS. Regular
      glucose testing — fasting glucose or HbA1c — is recommended as part
      of ongoing PCOS monitoring, especially with weight gain or a family
      history of diabetes.
  - q: "Does losing weight improve PCOS?"
    a: >-
      For overweight women with PCOS, modest weight loss of 5–10% of body
      weight can meaningfully improve hormonal profiles, restore ovulatory
      cycles, reduce insulin resistance, and improve acne and hirsutism. Weight
      management does not cure PCOS but can be among the most effective
      interventions available. For women at a healthy weight, lifestyle
      approaches focus on diet quality and physical activity rather than weight
      reduction.
  - q: "What medications are used for PCOS?"
    a: >-
      Treatment depends on your primary concerns. Metformin addresses insulin
      resistance, can restore cycles, and may support weight management. The
      oral contraceptive pill regulates periods and reduces androgen-driven
      symptoms (acne, hirsutism). Letrozole or clomiphene are used for
      ovulation induction when pregnancy is desired. Anti-androgens (e.g.,
      spironolactone) can help with hirsutism and acne in women not planning
      pregnancy. No single treatment works for everyone — a personalised plan
      addressing your specific concerns is important.
  - q: "Does PCOS go away at menopause?"
    a: >-
      Androgens tend to decline and cycles may become more regular as women
      with PCOS approach perimenopause, because the ovarian reserve diminishes.
      However, the metabolic and cardiovascular risks associated with PCOS —
      insulin resistance, dyslipidaemia, elevated blood pressure — persist and
      may even worsen at menopause, when oestrogen loss adds to the existing
      metabolic burden. Long-term metabolic monitoring remains important after
...
| Risk | Magnitude |
|---|---|
| Type 2 diabetes | 3–7× increased lifetime risk |
| Impaired fasting glucose or prediabetes | Common, even in lean women |
| Metabolic syndrome | 2–3× more prevalent |
| Non-alcoholic fatty liver disease | Elevated risk |
| Dyslipidaemia | Increased triglycerides, low HDL |
...
- [International Evidence-Based Guideline for the Assessment and Management of PCOS (Monash University)](https://www.monash.edu/medicine/sphpm/mchri/pcos) — the most comprehensive international clinical guideline
- [Jean Hailes for Women's Health — PCOS](https://www.jeanhailes.org.au/health-a-z/pcos) — plain-language patient resources
- [NHS — Polycystic Ovary Syndrome](https://www.nhs.uk/conditions/polycystic-ovary-syndrome-pcos/) — UK national guidance
- [Endocrine Society — PCOS Clinical Practice Guideline](https://www.endocrine.org/clinical-practice-guidelines/polycystic-ovary-syndrome) — specialist clinical guidance
...
- [Metabolic Syndrome: Risk, Diagnosis, and Prevention](/guides/metabolic-syndrome)
