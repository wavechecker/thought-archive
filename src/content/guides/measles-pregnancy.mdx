...
For a full step-by-step guide covering vaccination status, isolation, and post-exposure protection windows, see [Measles Exposure: What To Do](/guides/measles-exposure-what-to-do).
...
- [Measles Vaccine (MMR)](/guides/measles-vaccination)
