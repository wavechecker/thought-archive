...
export const HERO_PAGES: Record<string, HeroPageConfig> = {
  ...
  "womens-health": {
    ...
    description: "Menopause, PCOS, endometriosis, breast screening, cervical screening, and gynaecological conditions.",
    categoryKey: "Women's Health",
    whatThisCovers: [
      "Menopause, perimenopause, and hormone therapy",
      "PCOS, endometriosis, and common gynaecological conditions",
    ...
    featuredClusters: [
      {
        title: "Menopause",
        description: "Perimenopause, symptoms, hormone therapy, and long-term health.",
        href: "/guides/menopause",
      },
      {
        title: "PCOS",
        description: "Polycystic ovary syndrome — diagnosis, insulin resistance, fertility, and treatment.",
        href: "/guides/pcos",
      },
      {
        title: "Endometriosis",
        description: "Pelvic pain, diagnostic delay, hormonal treatments, and fertility.",
        href: "/guides/endometriosis",
      },
      {
      ...
      },
      {
        ...
        description: "Mammography, BI-RADS, dense breasts, and what to do after an abnormal result.",
        href: "/guides/mammography-breast-screening",
      },
    ],
  },
