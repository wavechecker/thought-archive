...
export const CATEGORY_DESCRIPTIONS: Record<string, string> = {
  ...
  "Kidney Health": "Chronic kidney disease, stages, monitoring, medicines, and related conditions.",
  ...
  "Aging & Longevity": "Aging biology, longevity interventions, healthspan, and what the evidence actually shows.",
